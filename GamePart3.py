...
encounter_list = ["enemy"] * 6 + ["nothing"] * 2 + ["item"] + ["treasure"]
...
while True:
    ...
    if choice == "1":
        ...
        if encounter == "enemy":
            ...
            enemy_damage = all_weapons[enemies[enemy]["weapon"]]["damage"]
            while is_fighting:
                fight_choice = input(
                ...
                if fight_choice == "1":
                    ...
                    while enemy_health > 0 and health > 0:
                      change_health(-enemy_damage)
                      enemy_health -= all_weapons[weapon]["damage"]
